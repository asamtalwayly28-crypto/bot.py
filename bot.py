...
command_aliases = {"اا": "افتاري", "اة": "افاتاري"} # اختصارات الأوامر
banned_words = set()
...
async def handle_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ["منشن", "@all", "تنزيل"]:
        try:
            ...
            await message.reply_text("عذراً، حدث خطأ أثناء تنفيذ المنشن الجماعي.")
        return
    ...
    if text in ["الاوامر", "الأوامر", "اوامر"]:
        full_text = (
            ...
            "- تفعيل / إلغاء تفعيل\n"
            "- منشن / @all / تنزيل (للمنشن الجماعي)\n"
            "- اضافة امر [الكلمة] [الرد] | اضافة اختصار\n"
...
def main():
    ...
    print("Bot Taif is running successfully and error-free...")
