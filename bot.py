...
# تخزين بيانات البنك والألعاب مؤقته
user_bank = {}

# 1. أمر /start ولوحة تحكم المطور المرتبة
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "- ايدي (لعرض معلوماتك وصورتك)\n"
        "- افتاري (لعرض صورتك الشخصية)\n"
        "- اهمس [المعرف] [النص] (لإرسال همسة سرية)\n"
        "- البنك (لعرض رصيدك وأرباحك)\n"
        "- اللعاب (عرض قائمة الألعاب المتاحة)\n"
        "- بحث [اسم الأغنية] (للبحث عن الأغاني)\n"
    )
    ...
    if user.id == DEV_ID:
        keyboard = [
            ...
            [InlineKeyboardButton("تفعيل وحماية القروبات", callback_data="toggle_protection")]
        ]
...
# 3. معالج الرسائل والأوامر والردود التلقائية والحماية
async def handle_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # أمر ايدي (يعرض المعلومات والصورة تماماً مثل بوت وعد)
    if text == "ايدي":
    ...
    # أمر البنك المرتب بدون إيموجيات
    if text == "البنك":
    ...
    # قائمة الالعاب المرتبة بدقة بدون إيموجيات
    if text == "اللعاب" or text == "الألعاب":
        games_list = (
            ...
            "3. سباق الخيل\n"
            "4. الروليت\n"
            "اكتب اسم اللعبة للبدء في اللعب."
        )
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "bot_stats":
        ...
        await query.edit_message_text("تم تحديث حالة حماية القروبات بنجاح.")
    elif query.data == "add_reply":
        await query.edit_message_text("لإضافة رد جديد، يرجى تزويدي بالكلمة والرد لأقوم بتحديثه في الكود.")
