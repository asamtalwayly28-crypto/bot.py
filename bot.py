...
# قوائم الألعاب والتفاعل والإضافات الكثيرة
ktweet_list = [
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "menu_m1":
        text = (
            ...
            "- افتاري: لعرض صورتك الشخصية وعدد أفتاراتك."
        )
        ...
        text = (
            ...
            "- رد بـ (منع) لحظر الكلمة.\n"
            "- رد بـ (مسح / حذف) لمسح الرسائل."
        )
        await query.edit_message_text(text, reply_markup=get_back_markup())
        ...
        text = (
            ...
            "- كت: لجلب سؤال كت تويت عشوائي.\n"
            "- صراحة: لجلب سؤال صراحة عشوائي.\n"
            "- سؤالي: لجلب سؤال إسلامي وثقافي.\n"
...
async def handle_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # الألعاب والاختصارات الجديدة المضافة
    if text == "كت":
    ...
    if text in ["الاوامر", "الأوامر", "اوامر"]:
        full_text = (
            ...
            "- تفعيل / إلغاء تفعيل\n"
            "- الرابط / بايو / بايو عشوائي / ايدي / الانشاء\n\n"
            "( الألعاب والتفاعل الجديدة )\n"
            "- كت (لكت تويت) | صراحة (أسئلة صراحة)\n"
            "- سؤالي (أسئلة إسلامية) | عواصم (لعبة العواصم)\n\n"
...
def main():
    ...
    print("Bot Taif is running with all games & shortcuts...")
